...
<div class="container-fluid">
   ...
   <div class="container-fluid">
      ...
      <br />
      <a href="<?= base_url() ?>/kelolalaporan/cetak_transaksikeluar" class="btn btn-success"><i class="fas fa-print"></i> Cetak Semua</a>
      <br />
      <br />
      <form method="POST" action="<?php base_url() ?>/kelolalaporan/cetak_trk_pertgl">
         <div class="row">
            <div class="col-2">
      ...
      <div class="card shadow mb-4">
         <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Laporan Transaksi Keluar</h6>
         </div>
         <div class="card-body">
