   ...
   <div class="container-fluid">
      ...
      <div class="card shadow mb-4">
         <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Pembayaran Diklat</h6>
         </div>
         <div class="card-body">
   ...
   <script type="text/javascript">
      ...
      $(document).ready(function() {
         tableData.DataTable({
            processing: true,
            serverSide: true,
            ajax: '<?= base_url('PembayaranPeserta/getData') ?>',
            columnDefs: [{
                  targets: -1,
                  orderable: false
               },
      ...
      $('.tomboltambah').click(function(e) {
         ...
         $.ajax({
            type: "POST",
            url: "<?= base_url('PembayaranPeserta/formtambah') ?>",
            dataType: "json",
      ...
      function hapus(id) {
         swal.fire({
            ...
            if (result.isConfirmed) {
               $.ajax({
                  type: "POST",
                  url: "<?= base_url('PembayaranPeserta/hapus') ?>",
                  data: {
                     id: id
                  },
                  dataType: "json",
