    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            tableData.DataTable({
                processing: true,
                serverSide: true,
                ajax: '<?= base_url('kelolapengajar/getDataPengajar') ?>',
                columnDefs: [{
                        targets: -1,
                        orderable: false
        ...
        $('.tomboltambah').click(function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "<?= base_url('kelolaPengajar/formtambah') ?>",
                dataType: "json",
        ...
        function hapus(id) {
            swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: "POST",
                        url: "<?= base_url('kelolapengajar/hapus') ?>",
                        data: {
                            id: id
                        },
                        dataType: "json",
