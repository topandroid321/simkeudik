     ...
     <li class="nav-item">
         ...
         <div id="transaksi" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
             <div class="bg-white py-2 collapse-inner rounded">
                 <a class="collapse-item" href="<?php base_url() ?>/pembayaranpeserta">Pembayaran</a>
                 <a class="collapse-item" href="<?php base_url() ?>/pembayaranpeserta/history">History Pembayaran</a>
             </div>
         </div>
     </li>
